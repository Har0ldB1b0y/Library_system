...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <a href="/"  class="btn btn-default btn-lg btn-block  btn-xlarge"><img src="/images/book.png" height="65" width="65"><br>
            ...
            <div class="col-md-6">
                <a href="/admin/reports/penalty-report"  class="btn btn-default btn-lg btn-block  btn-xlarge"><img src="/images/penalty.png" height="80" width="80"><br>
                    <span style="font-size: 10px;font-weight: bold;white-space: normal;" class="text text-success">Penalty Reports</span>
                </a>
                <br>
            </div>
